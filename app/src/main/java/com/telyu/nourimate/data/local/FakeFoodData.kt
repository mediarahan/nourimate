...
class FakeFoodData {
    ...
    val recipes = listOf(
        Recipe(
            ...
            cookingSteps = "1. Kocok telur bersama-sama dalam wadah. Bumbui dengan garam dan lada hitam.\n" +
                    ...
                    "5. Sajikan segera.",
            recipePictures = "vegetable_omelette"
        ),
        Recipe(
            recipeId = 2,
            name = "Tumis Ayam",
            ...
            recipePictures = "chicken_stir_fry"
        ...
        Recipe(
            ...
            recipePictures = "penne_bolognese"
        ),
        Recipe(
            recipeId = 5,
            ...
            recipePictures = "turkey_avocado_sandwich"
        ),
        Recipe(
            recipeId = 6,
        ...
        Recipe(
            ...
            recipePictures = "fuyunghai_sederhana"
        ),
        ...
        Recipe(
            ...
            recipePictures = "salad_mediterania"
        ),
        ...
        Recipe(
            ...
            recipePictures = "chili_con_carne"
        ),
        ...
        Recipe(
            ...
            recipePictures = "sate_ayam_madura"
        ),
        Recipe(
            recipeId = 20,
            name = "Es Cendol",
        ...
        Recipe(
            ...
            recipePictures = "nasi_goreng_jawa"
        ),
        Recipe(
            recipeId = 23,
            name = "Pepes Ikan Mas",
    ...
    val recipeMeal = listOf(
        RecipeMeal(recipeId = 3, mealId = 2),
        RecipeMeal(recipeId = 10, mealId = 1),
        RecipeMeal(recipeId = 15, mealId = 3),
        RecipeMeal(recipeId = 20, mealId = 2),
        RecipeMeal(recipeId = 24, mealId = 1),
        RecipeMeal(recipeId = 19, mealId = 1),
        RecipeMeal(recipeId = 19, mealId = 2),
