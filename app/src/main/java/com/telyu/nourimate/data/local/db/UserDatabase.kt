...
@Database(entities = [Detail::class,User::class, Profpic::class, SleepSegmentEventEntity::class, WeightEntry::class, WeightTrack::class, History::class], version = 1, exportSchema = false)
