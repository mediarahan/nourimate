...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun disableRegisterButton() {
        ...
        binding.buttonRegister.setBackground(ContextCompat.getDrawable(this, R.drawable.buttonlogin_background_with_shadow_disable))  // Menggunakan background untuk disabled
        binding.buttonRegister.setTextColor(ContextCompat.getColor(this, R.color.color26))  // Set to gray text color
    }

    private fun enableRegisterButton() {
        binding.buttonRegister.isEnabled = true
        binding.buttonRegister.setBackground(ContextCompat.getDrawable(this, R.drawable.buttonlogin_background_with_shadow))  // Menggunakan background untuk enabled
